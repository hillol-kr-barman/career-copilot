...
- Strong system architectural design patterns understanding`
  ...
  const renderHiglightedMMR = (text: string) => {
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <div className="border border-red-500/20 bg-red-500/10 rounded-2xl p-4 md:p-5 flex flex-col gap-3 shadow-xs">
          ...
          <div className="whitespace-pre-wrap text-xs md:text-sm font-semibold text-red-300 font-mono leading-relaxed bg-[#13161C] p-3 rounded-lg border border-red-500/10">
            {formattedMMR}
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col min-h-screen text-slate-800 selection:bg-blue-500 selection:text-white">
      
      {/* Dynamic API Warning message */}
      {!apiKeyStatus.loading && !apiKeyStatus.hasApiKey && !userApiKey && (
        <div className="bg-amber-100 text-amber-900 border-b border-amber-200 text-xs md:text-sm font-semibold px-4 py-3 text-center flex items-center justify-center gap-2 shadow-xs transition-all">
      ...
      <header className="sticky top-0 z-[100] w-full max-w-5xl mx-auto px-4 pt-4 pb-2 bg-transparent backdrop-blur-sm">
        <div className="flex items-center justify-between gap-4 h-14 px-6 rounded-full border border-white/60 bg-white/90 backdrop-blur-2xl shadow-lg ring-1 ring-slate-200/50 hover:scale-[1.01] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
          {/* Logo Brand */}
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-blue-600 animate-pulse" />
            <span className="font-display font-semibold text-xs md:text-sm tracking-widest text-[#0F172A] uppercase">
              CAREER COPILOT
            </span>
            {isAdmin && (
              <span className="text-[9px] bg-blue-500/10 text-blue-600 border border-blue-500/20 rounded-full px-2 py-0.5 font-bold uppercase tracking-wider">
                ADMIN
              </span>
            )}
          </div>
          ...
          <nav className="flex items-center gap-1 md:gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-full text-[11px] md:text-xs font-semibold tracking-wide transition-all ${
                activeTab === "resume"
      ...
      {showSettings && (
        <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/40 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-white/90 backdrop-blur-2xl border-l border-white/60 p-6 md:p-8 flex flex-col gap-6 shadow-2xl h-full overflow-y-auto animate-in slide-in-from-right duration-200 text-slate-800">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <h2 className="text-lg font-bold font-display text-slate-950">AI Settings & Auth</h2>
              <button
            ...
            <div className="flex flex-col gap-3">
              <label className="text-xs font-semibold uppercase tracking-wider text-slate-400">Target Model</label>
              <select
                value={selectedModel}
                onChange={(e) => {
                ...
                className="w-full p-2.5 border border-slate-200 bg-white rounded-xl text-xs font-semibold text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 shadow-2xs"
              >
            ...
            <div className="flex flex-col gap-3 border-t border-slate-100 pt-5">
              <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">API Key Credentials</p>
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-150 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className={`w-2 h-2 rounded-full ${userApiKey ? "bg-emerald-500" : (apiKeyStatus.hasApiKey ? "bg-blue-500 animate-pulse" : "bg-amber-500")}`} />
              ...
              <input
                ...
                className="w-full p-2.5 border border-slate-200 bg-white rounded-xl text-xs font-mono text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <p className="text-[10px] text-slate-400 leading-normal">
            ...
            <div className="mt-auto pt-6 border-t border-slate-100">
              <button
                onClick={() => setShowSettings(false)}
                className="w-full bg-slate-900 text-white text-xs font-semibold py-3 rounded-full hover:bg-slate-800 uppercase tracking-widest active:scale-95 transition-all"
              >
                Close Settings
              </button>
            </div>
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 pt-1 pb-8 md:pt-2 md:pb-10">
        ...
        <div className="mb-6 relative overflow-hidden rounded-[2.5rem] bg-white/70 border border-slate-200/80 text-slate-800 shadow-lg ring-1 ring-black/5">
          ...
          <div className="relative z-10 px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[220px] md:min-h-[240px]">
            <div>
              <p className="text-[10px] md:text-xs font-semibold uppercase tracking-widest text-[#2563EB] bg-[#2563EB]/10 border border-[#2563EB]/20 px-3.5 py-1.5 rounded-full w-fit mb-5">
                ✦ Space-Prism AI Engine Enabled
              </p>
              <h1 className="text-3xl md:text-5xl font-light font-display tracking-tight leading-none text-slate-950 max-w-3xl">
                Resume and <span className="font-medium text-blue-600">Interview Tool</span>
              </h1>
              <p className="text-xs md:text-sm text-slate-500 max-w-2xl mt-4 leading-relaxed font-sans">
            ...
            <div className="grid grid-cols-3 gap-4 border-t border-slate-100 pt-6 md:pt-8 mt-8 w-fit md:w-3/4">
              <div>
                <p className="text-2xl md:text-3xl font-display font-semibold tracking-tight text-slate-900">150K+</p>
                <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">Audits</p>
              </div>
              <div>
                <p className="text-2xl md:text-3xl font-display font-semibold tracking-tight text-slate-900">99.8%</p>
                <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">Precision</p>
              </div>
              <div>
                <p className="text-2xl md:text-3xl font-display font-semibold tracking-tight text-slate-900">180+</p>
                <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">Industries</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 w-full relative">
          <div className="bg-white/90 backdrop-blur-2xl border border-white/60 p-5 rounded-3xl shadow-lg ring-1 ring-slate-200/50 hover:scale-[1.012] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
            <div className="flex flex-col md:flex-row gap-6 items-stretch justify-between">
              
              {/* Box Info - AI Engine Details */}
              <div className="flex-1 flex gap-4 items-center">
                <div className="p-3 bg-gradient-to-tr from-blue-500/10 to-indigo-500/10 border border-blue-100 rounded-2xl shrink-0">
                  <Sparkles className="w-5 h-5 text-blue-600 animate-pulse" />
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-slate-800 tracking-tight flex items-center gap-1.5">
                    AI Active Parameters
                    <span className="text-[10px] bg-blue-100 text-blue-700 font-mono font-semibold px-2 py-0.5 rounded-full uppercase tracking-wider">Online</span>
                  </h3>
              ...
              <div className="flex flex-col gap-1.5 justify-center">
                <label htmlFor="model_select" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">
                  Target AI Model
                </label>
                <select
                  id="model_select"
                  ...
                  className="p-2.5 pr-8 border border-slate-200 bg-white rounded-xl text-xs font-semibold text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 shadow-2xs font-mono"
                >
                  <option value="gemini-2.5-flash">gemini-2.5-flash (Fast & recommended)</option>
                  <option value="gemini-2.5-pro">gemini-2.5-pro (Highly analytical)</option>
                  <option value="gemini-1.5-flash">gemini-1.5-flash (Stable lightweight)</option>
              ...
              <div className="flex flex-col gap-1.5 justify-center md:w-80">
                <div className="flex justify-between items-center">
                  <label htmlFor="api_key_override" className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">
                    Your Personal API Key
                  </label>
                  <div className="flex items-center gap-1.5">
                    <span className={`w-1.5 h-1.5 rounded-full ${userApiKey ? "bg-emerald-500 animate-ping" : (apiKeyStatus.hasApiKey ? "bg-blue-500" : "bg-amber-500")}`} />
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-2.5 pr-10 border border-slate-200 bg-white rounded-xl text-xs font-mono text-slate-800 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 shadow-2xs placeholder:text-slate-300"
                  />
                  <button
                    type="button"
        ...
        {activeTab === "resume" && (
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white/90 backdrop-blur-2xl border border-white/60 p-5 md:p-6 rounded-3xl shadow-lg ring-1 ring-slate-200/50 hover:scale-[1.012] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
              {/* Header */}
              <div className="flex items-center gap-3 mb-5 pb-4 border-b border-slate-100">
                <div className="p-2.5 bg-gradient-to-tr from-violet-500/10 to-purple-500/10 border border-violet-100 rounded-2xl shrink-0">
                  <CheckCircle2 className="w-5 h-5 text-violet-600" />
                </div>
                <div className="flex-1">
                  <h3 className="text-sm font-semibold text-slate-800 tracking-tight flex items-center gap-2">
                    AI Content Detection
                    <span className="text-[10px] bg-violet-100 text-violet-700 font-mono font-semibold px-2 py-0.5 rounded-full uppercase tracking-wider">Zero-Shot</span>
                  </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <textarea
                    ...
                    className="w-full text-xs text-slate-800 bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 resize-none font-mono leading-relaxed"
                  />
                  {aiDetectFileName && (
                    <span className="text-[10px] font-medium text-violet-600 bg-violet-500/10 px-2 py-0.5 rounded-md border border-violet-500/20 w-fit">
                      ✓ {aiDetectFileName}
                    </span>
                  )}
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 text-white font-semibold text-xs uppercase tracking-widest py-3.5 rounded-full shadow-md active:scale-95 hover:scale-[1.01] transition-all disabled:opacity-50 disabled:pointer-events-none"
                  >
                    {isDetecting ? (
                      <>
                ...
                <div className="flex flex-col items-center justify-center bg-slate-50/60 rounded-2xl border border-slate-150 p-5 min-h-[200px]">
                  {!aiDetectResult && !isDetecting && (
                    <div className="flex flex-col items-center gap-3 text-center">
                      ...
                      <p className="text-xs text-slate-400 font-sans max-w-[180px] leading-relaxed">
                        Upload or paste text and click <b className="text-slate-500">Check AI Rate</b> to scan.
                      </p>
                    </div>
                  )}
                  ...
                  {isDetecting && (
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-xs text-slate-400">Analyzing content patterns...</p>
                    </div>
                  )}
                  ...
                  {aiDetectResult && !isDetecting && (() => {
                    ...
                    const borderColor = isHigh ? "border-red-200" : isMid ? "border-amber-200" : "border-emerald-200";
                    const label = isHigh ? "Likely AI-Generated" : isMid ? "Possibly AI-Assisted" : "Likely Human-Written";
                    return (
                      <div className="w-full flex flex-col items-center gap-4">
                        {/* Circular gauge */}
                        <div className={`relative w-28 h-28 rounded-full border-4 ${borderColor} flex items-center justify-center bg-white shadow-sm`}>
                          <div className="flex flex-col items-center">
                            <span className={`text-3xl font-extrabold font-mono tracking-tight ${color}`}>{pct}%</span>
                            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">AI Rate</span>
                          </div>
                        </div>
                        {/* Progress bar */}
                        ...
                        {/* Engine badge */}
                        <span className="text-[10px] text-slate-400 font-mono bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-full">
            ...
            <StackingContainer cardBaseTop={72} cardTopStep={24}>
              ...
              <StackingCard
                ...
                colorTheme={{ text: "#2563eb", bg: "rgba(37,99,235,0.08)", border: "rgba(37,99,235,0.15)" }}
              >
                <div className="flex flex-col gap-2">
                  <label htmlFor="resume_jd_editor" className="text-[10px] md:text-xs font-semibold text-slate-400 uppercase tracking-wider">
                  ...
                  <textarea
                    ...
                    className="w-full text-xs md:text-sm text-slate-800 bg-slate-50 border border-slate-250 rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none shadow-sm transition-all"
                  />
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2 bg-slate-50/50 p-4 rounded-2xl border border-slate-150 shadow-xs">
                    ...
                    <textarea
                      ...
                      className="w-full text-xs text-slate-800 bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none resize-none flex-1 font-mono leading-relaxed"
                    />
                    {resumeFileName && (
                      <span className="text-[10px] font-medium text-blue-600 bg-blue-500/10 px-2 py-0.5 rounded-md border border-blue-500/20 w-fit">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      className="w-full text-xs md:text-sm text-slate-800 bg-slate-50 border border-slate-250 rounded-2xl p-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none shadow-sm transition-all"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="w-full relative flex items-center justify-center gap-2 bg-[#3b82f6] hover:bg-blue-500 text-white font-semibold text-xs md:text-sm uppercase tracking-widest py-4 rounded-full shadow-lg hover:shadow-xl active:scale-98 hover:scale-[1.01] transition-all disabled:opacity-55 disabled:pointer-events-none"
                    >
                      {isAnalyzingResume ? (
                        <>
                          <RefreshCw className="w-4 h-4 animate-spin" />
            ...
            {resumeReport && (
              <section id="results-panel" className="bg-white/90 backdrop-blur-2xl border border-white/60 rounded-3xl p-6 md:p-8 shadow-xl hover:scale-[1.005] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] flex flex-col gap-6 scroll-mt-24 text-slate-800">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 pb-4">
                  <div>
                    <h2 className="text-xl md:text-2xl font-semibold font-display text-slate-900 tracking-tight">
                      Generated Dynamic Resume Report
                    </h2>
                    <p className="text-xs text-slate-400 mt-1">
                      Report outputs parsed into optimized tabs. Model used: <span className="font-mono text-[11px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100">{resumeReport.modelUsed}</span>
                    </p>
                  </div>
                  <button
                    onClick={() => handleDownload("resume-review-report.txt", resumeReport.body)}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-50 hover:bg-blue-100/70 border border-blue-200 text-blue-600 text-xs font-semibold transition-all active:scale-95 shadow-2xs"
                  >
                ...
                <div className="flex flex-wrap gap-1 border-b border-slate-100 pb-2">
                  {resumeReport.tabSections.map((section) => (
                    <button
                      ...
                      className={`text-[9px] md:text-[11px] font-semibold tracking-wider uppercase px-3 py-1.5 rounded-lg border transition-all ${
                ...
                <div className="bg-slate-50/60 rounded-2xl p-5 md:p-6 border border-slate-150 min-h-[250px] transition-all">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="whitespace-pre-wrap text-sm text-slate-705 leading-relaxed font-sans">
                        {activeSec.content}
                      </div>
                    );
                  })()}
        ...
        {activeTab === "interview" && (
          <div className="flex flex-col gap-6">
            <StackingContainer cardBaseTop={72} cardTopStep={24}>
              ...
              >
                <div className="flex flex-col gap-2">
                  <label htmlFor="interview_jd_editor" className="text-[10px] md:text-xs font-semibold text-slate-400 tracking-wider uppercase">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-3 justify-center">
                    <p className="text-xs text-slate-500 leading-relaxed md:px-2 font-sans">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 bg-[#2563eb] hover:bg-blue-600 text-white font-semibold text-xs md:text-sm uppercase tracking-widest py-3.5 px-4 rounded-full shadow-md active:scale-95 transition-all disabled:opacity-50"
                    >
                ...
                {questionsReport && (
                  <div className="mt-4 border-t border-slate-100 pt-4 flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-bold text-slate-400 tracking-wider uppercase">Generated Simulator Context</span>
                      <button
                    ...
                    <div className="max-h-48 overflow-y-auto p-4 bg-slate-50 rounded-xl border border-slate-200 font-mono text-[11px] text-slate-700 whitespace-pre-wrap leading-relaxed">
                      {questionsReport}
                    </div>
                  </div>
                )}
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  ...
                  <div className="bg-slate-50 border border-slate-200/90 p-5 rounded-2xl flex flex-col items-center justify-center gap-2 shadow-xs">
                    ...
                    <div className="flex items-baseline gap-1 mt-2">
                      ...
                      <span className="text-slate-400 text-xs font-mono">/ 1.00</span>
                    </div>
                    <div className="w-full bg-slate-200/50 h-2 rounded-full overflow-hidden mt-2">
                      <div 
                  ...
                  <div className="bg-slate-50 border border-slate-200/90 p-5 rounded-2xl flex flex-col items-center justify-center gap-2 shadow-xs">
                    ...
                    <span className={`text-4xl font-extrabold font-mono mt-2 ${currentMetrics.weakCount > 0 ? "text-red-500 animate-pulse" : "text-slate-800"}`}>
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    {interviewError && (
                      <div className="p-3 bg-red-500/10 text-red-500 border border-red-500/15 rounded-xl text-xs flex items-center gap-2 font-medium">
                        <AlertTriangle className="w-4 h-4 shrink-0" />
                    ...
                    <button
                      ...
                      className="w-full relative flex items-center justify-center gap-2 bg-[#2563eb] hover:bg-blue-600 text-white font-semibold text-xs py-4 uppercase tracking-widest rounded-full shadow-lg hover:shadow-xl active:scale-98 transition-all disabled:opacity-50"
                    >
            ...
            {evaluationReportText && (
              <section id="results-assessor-panel" className="bg-white/90 backdrop-blur-2xl border border-white/60 rounded-3xl p-6 md:p-8 shadow-xl hover:scale-[1.005] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] flex flex-col gap-5 scroll-mt-24 text-slate-800">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 pb-4">
                  <div>
                    <h2 className="text-xl md:text-2xl font-semibold font-display text-slate-900 tracking-tight">
                ...
                <div className="bg-slate-50/60 rounded-2xl p-5 md:p-6 border border-slate-150 whitespace-pre-wrap text-sm text-slate-700 leading-relaxed font-sans">
                  {evaluationReportText}
                </div>
              </section>
            )}
        ...
        {activeTab === "manage" && (
          <div className="w-full max-w-2xl mx-auto bg-white/90 backdrop-blur-2xl border border-white/60 p-6 md:p-8 shadow-xl hover:scale-[1.01] transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] flex flex-col gap-6 text-slate-850 col-span-1">
            {!isAdmin ? (
              <form onSubmit={handleAdminLoginSubmit} className="flex flex-col gap-5">
                <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                  <div className="p-3 bg-slate-50 border border-slate-150 rounded-2xl text-slate-700">
                    <Lock className="w-5 h-5" />
                  </div>
                  <div>
                    <h2 className="text-lg font-bold font-display text-slate-900">Admin Sign In Required</h2>
                    <p className="text-xs text-slate-400">Unlock default systemic fallback prompts configuration.</p>
                  </div>
                </div>

                {adminError && (
                  <div className="p-3 bg-red-500/10 text-red-500 border border-red-500/15 rounded-xl text-xs flex items-center gap-2">
                    <AlertTriangle className="w-4 h-4 shrink-0" />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-slate-200 bg-slate-50 rounded-xl text-xs focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none text-slate-800 placeholder-slate-400"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-slate-200 bg-slate-50 rounded-xl text-xs focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none text-slate-800"
                  />
                  <span className="text-[10px] text-slate-400 mt-1 font-sans">Hint for tester: username <b className="text-slate-600">qibaitintern</b> / password <b className="text-slate-600">qibaitintern</b></span>
                </div>

                <button
                  type="submit"
                  disabled={isLoggingIn}
                  className="w-full bg-[#2563eb] text-white text-xs font-semibold py-3.5 rounded-full hover:bg-blue-600 tracking-widest uppercase mt-2 active:scale-95 transition-all disabled:opacity-50"
                >
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-slate-50 border border-slate-150 text-blue-600 rounded-2xl">
                      <FolderLock className="w-5 h-5" />
                    </div>
                    <div>
                      <h2 className="text-lg font-bold font-display text-slate-900">Configure Default Prompts</h2>
                      <p className="text-xs text-slate-400">Settings currently synced with local storage fallback layers.</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setIsAdmin(false)}
                    className="text-xs bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-700 font-semibold px-3 py-1.5 rounded-full transition-all"
                  >
                    Log Out
                  </button>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Resume Default Prompt Falling Guidelines</label>
                  <textarea
                    rows={4}
                    value={defaultResumePr || "SYSTEM DEFAULT LOADED"}
                    onChange={(e) => setDefaultResumePr(e.target.value)}
                    className="w-full p-3 border border-slate-200 bg-slate-50 rounded-xl text-xs text-slate-700 font-mono focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none shadow-sm"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Interview Question Default Prompts</label>
                  <textarea
                    rows={4}
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Diagnostic Evaluation Default Prompt Guidelines</label>
                  <textarea
                    rows={4}
                ...
                <div className="flex justify-between items-center bg-slate-50 p-4 rounded-2xl border border-slate-200 mt-2">
                  <div className="text-xs text-slate-400 font-sans">
                    <b>Reference Directories:</b> Local reference files mapped inside <span className="font-mono text-blue-600 bg-blue-50 px-1 py-0.5 rounded border border-blue-100">/anzsco</span> and <span className="font-mono text-blue-600 bg-blue-50 px-1 py-0.5 rounded border border-blue-105">/sifa</span> configurations.
                  </div>
                </div>
              </div>
            )}
      ...
      <footer className="w-full text-center py-8 border-t border-slate-200 text-[10px] tracking-widest text-slate-400 uppercase mt-auto">
