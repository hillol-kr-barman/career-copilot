...
export default function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-[#eef0f3] selection:bg-[#00d4dc] selection:text-[#0a0c0d]">
      ...
      <header className="w-full max-w-5xl mx-auto px-4 pt-4 pb-2">
        <div className="flex items-center justify-between gap-4 h-14 px-6 rounded-[10px] border border-[rgba(255,255,255,0.07)] bg-[#161a1e]">
          ...
          <nav className="flex items-center gap-1">
            <a
              ...
              className="px-3 py-2 rounded-[5px] text-[11px] md:text-xs font-semibold tracking-wide text-[#9aa3b0] hover:text-[#eef0f3] hover:bg-[#1c2128] transition-all"
            >
              AI Detection
            </a>
            <a
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 pt-1 pb-8 md:pt-2 md:pb-10 flex flex-col gap-6">
        {/* Hero */}
