...
`.trim();
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <label htmlFor={id} className="text-[10px] md:text-xs font-semibold tracking-wider text-slate-400 uppercase">
        {label}
      </label>
      ...
      <div
        ...
        className={`relative flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-6 transition-all duration-200 cursor-pointer text-center select-none ${
          dragActive 
            ? "border-blue-500 bg-blue-50/20 scale-[1.01]" 
            : "border-slate-200 bg-slate-50/60 hover:border-[#2563eb]/40 hover:bg-[#2563eb]/5"
        }`}
      >
        <input
          ref={inputRef}
        ...
        {!selectedFile ? (
          <div className="flex flex-col items-center gap-2">
            <div className="p-3 rounded-full bg-white border border-slate-150 text-slate-400 shadow-xs">
          ...
          <div className="flex items-center justify-between w-full p-2 bg-slate-50 border border-slate-200 rounded-xl">
      ...
      {errorMsg && (
        <div className="flex items-center gap-2 text-[10px] md:text-xs text-red-500 font-medium bg-red-500/10 p-2 rounded-lg border border-red-500/20">
